...
*///?}
// NeoForge moved the client-to-server send to ClientPacketDistributor by 1.21.10, where
// PacketDistributor has no sendToServer at all. Both are covered so send() keeps the same call
